    ...
    <tr>
        ...
        <td id="td_content_box">
         	<div id="main_content_box"> <!-- MAIN CONTENT BOX -->
				...
				<h2 id="h2_heading">שגיאה: <%= response.getStatus() %></h2>
				
				<ul id="ul_edit_user" class="list-group" style="width: 900px;">
					<li class="list-group-item">

						<div style='color: #a94442; font-size: 18px;'><span class='glyphicon glyphicon-remove'></span>
					תיאור השגיאה:
						<pre style="text-align: left;"><%=InputCheck.formInputCheck(exception.getMessage()) %></pre>
						 </div>					
